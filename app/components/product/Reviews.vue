...
const testimonials = ref([
  ...
  },
  {
    ...
    quote:
      "The quality is incredible for the price. I will definitely shop here again.",
  },
  {
    user: {
      stars: 3,
    ...
    quote:
      "I'm very happy with my purchase, it exceeded my expectations and the customer service was excellent.",
  },
  {
    user: {
      stars: 2,
  ...
  },
  {
    ...
    quote:
      "Great shopping experience, product exactly as described and very good quality.",
  },
  {
    user: {
      stars: 1,
  ...
  },
  {
    ...
    quote: "Excellent service and good product. Everything arrived very well and fast.",
  },
  {
    user: {
      stars: 3,
    ...
    quote: "Good price and quality, no issues with the order. I recommend it.",
  },
  {
    user: {
      stars: 4,
  ...
  },
  {
    ...
    quote: "First time buying and everything went excellently. 100% recommended.",
  },
  {
    user: {
      stars: 5,
    ...
    quote:
      "I was surprised by the quality. Shipping was also very fast. Thank you!",
  },
]);
</script>
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-gray-600 text-sm">
            Our reviews from satisfied customers.
          </p>
        </div>
      </div>
      <!-- <UButton
